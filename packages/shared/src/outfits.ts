/*
 * File: packages/shared/src/outfits.ts
 * Purpose: Shared mock outfits dataset for reuse across web and mobile.
 */
import { Outfit } from './types';

// Generate 1000+ outfits with diverse categories and styles (shared)
...
// Enrich a few items with multi-image galleries for a better demo
